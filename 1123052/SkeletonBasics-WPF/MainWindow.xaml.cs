...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
                ...
                if (skeletons.Length != 0)
                {
                    foreach (Skeleton skel in skeletons)
                    {
                        if (skel.TrackingState == SkeletonTrackingState.Tracked)
                        {
                            ...
                            Inner_Product(skel, JointType.HandLeft, JointType.ElbowLeft, JointType.ShoulderLeft);
        ...
        void Inner_Product(Skeleton skeleton, JointType j1, JointType j2, JointType j3)
        {
            Vector4 vec1, vec2;
            ...
            AA = v1.X * v1.X + v1.Y * v1.Y + v1.Z * v1.Z;

            BB = v2.X * v2.X + v2.Y * v2.Y + v2.Z * v2.Z;

            AB = v1.X * v2.X + v1.Y * v2.Y + v1.Z * v2.Z;

...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            {
                // 左腕
                if (this.dot_LeftA < 0.5f)
                    f_LeftA = false; // 肩と手の距離が遠い
                else
                    f_LeftA = true;　// 肩と手の距離が近い


                if (this.dot_RightA < 0.5f)
                    f_RightA = false; // 肩と手の距離が遠い
                else
                    f_RightA = true;  // 肩と手の距離が近い
                
                if(f_LeftA == false && f_RightA == false)
                    dc.DrawRectangle(Brushes.Black, null, new Rect(0.0, 0.0, RenderWidth, RenderHeight));
                else if (f_LeftA == true && f_RightA == true)
                {
                    this.ScreenShot();
                    label1.Content = "SNAP！";
                }
                ...
                {
                    dc.DrawRectangle(Brushes.Blue, null, new Rect(0.0, 0.0, RenderWidth, RenderHeight));
                    label1.Content = "";
                }
                    

                if (f_LeftA == true)
                    label3.Content = "1123033\n小島健太郎\n\n1123051\n古川佳樹\n\n1123052\n川口悠哉\n\n1123183\n齊間勇喜\n";
                else
                    label3.Content = "";
                ...
                if (skeletons.Length != 0)
                {
                    foreach (Skeleton skel in skeletons)
                    {
                        if (skel.TrackingState == SkeletonTrackingState.Tracked)
                        {
                            ...
                            // 左腕の内積を取得
                            dot_LeftA = Inner_Product(skel, JointType.HandLeft, JointType.ElbowLeft, JointType.ShoulderLeft);

                            // 右腕の内積を取得
                            dot_RightA = Inner_Product(skel, JointType.HandRight, JointType.ElbowRight, JointType.ShoulderRight);

                            label1.Content = dot_LeftA;
                        }
        ...
        private float Inner_Product(Skeleton skeleton, JointType j1, JointType j2, JointType j3)
        {
            Vector4 vec1, vec2;
